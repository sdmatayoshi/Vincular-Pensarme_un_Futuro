...
<body>
    ...
    <script>
        var stylesURL = "https://raw.githubusercontent.com/sdmatayoshi/Vincular-Pensarme_un_Futuro/main/css/styles.css?nocache=" + new Date().getTime();
        fetch(stylesURL)
        .then(response => response.text())
            .then(cssData => {
                document.getElementById("css").innerHTML += cssData;
            })
