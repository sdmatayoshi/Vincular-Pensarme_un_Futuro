...
<body>
    <div class="navbar">
        <ul class="menu">
            ...
            <li>
                <a class="und D2U" style="text-decoration: underline; color:rgba(50, 50, 50, 1); cursor: pointer">Nuestra tarea ▾</a>
                <ul class="dropdown">
                    <li><a class="und" href="nuestrosProyectos.php">Nuestros Proyectos</a>
                    </li>
                    <li><a class="und" href="formacionAsistencia.php">Formacion y
                            Asistencia Técnica</a></li>
                    <li><a class="und" href="galeria.php">Red Solidaria
                            "Vincularnos"</a></li>
                </ul>
            </li>
            <li><a class="und D2U" href="contactanos.php">Contáctanos</a></li>
            <li><a class="und D2U" href="colaboraciones.php">Participar</a></li>
            <li><a class="und D2U" href="redVincular.php">Galería</a></li>
        </ul>
    </div>
