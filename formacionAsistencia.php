        ...
        <ul class="menu">
            ...
            <li>
                ...
                <ul class="dropdown">
                    ...
                    <li><a class="und" style="text-decoration: underline; color:rgba(50, 50, 50, 1); cursor: pointer">Formacion y Asistencia Técnica</a></li>
    ...
    <div class="has-bg-img">
        <div class="content" style="margin-top: 3vw;">
            <div class="R2L" style="text-align: left; width: 75%; margin-left: 5vw; margin-top: 50px;">
                <h1>Formación y asistencia técnica</h1><br><br>
                <p>
                Una apuesta al acompañamiento y a la transmisión, desde la perspectiva de derechos, 
                junto a instituciones y organizaciones que trabajan con infancias y adolescencias.
            </p><br>
            </div>
