            ...
            * {
            ...
            .has-bg-img::before {
                ...
                background: linear-gradient(to top, rgba(228, 240, 235, 1) 0%, rgba(228, 240, 235, 0) 20%),
                    url(https://raw.githubusercontent.com/sdmatayoshi/Vincular-Pensarme_un_Futuro/refs/heads/main/img/v2.jpg);
...
<div class="navbar">
    ...
    <div class="has-bg-img">
        ...
        <div class="R2L" style="text-align: center; width: 1000px; margin-top: 60px;">
                <center><img src="https://raw.githubusercontent.com/sdmatayoshi/Vincular-Pensarme_un_Futuro/refs/heads/main/img/vicon.jpg" alt="" style="height:100px;"></center><br><br>
    ...
    <script>
        fetch("https://raw.githubusercontent.com/sdmatayoshi/Vincular-Pensarme_un_Futuro/refs/heads/main/content/viajes.txt?nocache=" + new Date().getTime())
