            ...
            * {
            ...
            .has-bg-img::before {
                ...
                background: linear-gradient(to top, rgba(228, 240, 235, 1) 0%, rgba(228, 240, 235, 0) 20%),
                    url(https://vincular.org.ar/wp-content/uploads/2025/03/proyecto.jpg);
...
<div class="navbar">
    ...
    <script>
        fetch("https://raw.githubusercontent.com/sdmatayoshi/Vincular-Pensarme_un_Futuro/refs/heads/main/content/nuestrosProyectos.txt?nocache=" + new Date().getTime())
